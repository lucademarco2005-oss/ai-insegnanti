...
> **Chiave trasversale (vale a ogni livello):** un buon prompt non è un linguaggio segreto, è dire bene quello che già sapete di voler ottenere. Vale dall'infanzia alle superiori e per la segreteria.
...
- **2. Contesto:** chi sei, chi è il destinatario, che ruolo deve avere l'IA, quali dettagli servono. L'IA non sa niente di voi se non glielo dite. Nota: "sei un esperto" generico serve a poco; serve un ruolo concreto (maestra di quarta, 22 alunni, prima volta sull'argomento).
...
**Esempio 2 · Spiegare un concetto (primaria)**
- Male: *"Spiega le frazioni."*
- Bene: *"Sei un maestro di quarta. Spiega le frazioni a bambini di 9 anni che le incontrano per la prima volta. Usa un solo esempio concreto e quotidiano (la pizza), frasi brevi, nessun termine tecnico non spiegato. Massimo 150 parole. Concludi con 3 domande semplici per capire se hanno capito. Se usi una parola difficile, spiegala subito tra parentesi."*
- Le 5 fasi: Obiettivo (150 parole, 3 domande) · Contesto (maestro, 9 anni, prima volta) · Esempi (la pizza) · Valutazione (3 domande di controllo) · Iterazione (vincolo sulle parole difficili).

**Esempio 3 · Comunicazione ai genitori (segreteria/ATA)**
- Male: *"Scrivi una mail ai genitori per l'uscita didattica."*
- Bene: *"Sei la segreteria di una scuola primaria. Scrivi una comunicazione ai genitori per un'uscita al museo di scienze il 14 marzo. Tono cordiale e chiaro, massimo 120 parole. Devono risultare evidenti: ritrovo e rientro, costo, cosa portare, scadenza per l'autorizzazione. Chiudi con i contatti della segreteria. Non usare un tono burocratico."*
- Le 5 fasi: Obiettivo (120 parole, info chiave) · Contesto (segreteria, primaria) · Materiali (i dati dell'uscita) · Valutazione (cosa deve risultare evidente) · Iterazione (negativo: niente burocratese).
...
- Versione umana: *"Quest'anno dedichiamo una settimana alla lettura. Dal 10 al 14 marzo, in ogni classe, mezz'ora al giorno per leggere insieme: libri scelti dai ragazzi, ad alta voce o in silenzio. Leggere a quell'età aiuta a trovare le parole e a mettersi nei panni degli altri. Ma soprattutto è un piacere, e vorremmo che i bambini lo riscoprissero senza il peso del voto. Chi vuole, porti da casa un libro a cui tiene."*
...
- Vale a ogni livello: chi insegna alle superiori genera la verifica o la scheda, alla primaria la storia o il gioco, la segreteria la comunicazione. Stesso metodo.
